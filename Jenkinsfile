pipeline{
    ...
    stages{
       ...
       stage('SonarQube analysis') {
		...
		sh "mvn clean verify sonar:sonar -Dsonar.projectKey=CICD -Dsonar.host.url=http://52.2.233.149:9000 -Dsonar.login=sqp_34f6fa6d0f87e3cd2a9626a6f17cdbb1489936e8"
